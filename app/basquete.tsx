...
export default function Basquete() {
  ...
  useEffect(() => {
    const avisosRef = ref(database, "Atividades/basquete/Avisos");
    ...
    const unsubscribe = onValue(avisosRef, (snapshot) => {
      if (snapshot.exists()) {
        ...
        // Ordena por timestamp (mais recentes primeiro) e limita a 4 eventos
            ...
            <View style={estilos.secaoSuperior}>
              ...
              <View style={estilos.containerAvisos}>
                ...
                {avisosArray.length > 0 ? (
                  ...
                  <Text style={estilos.textoAvisos}>Nenhum evento disponível</Text>
                )}
              </View>
            </View>
